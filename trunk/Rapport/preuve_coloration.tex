...
\centering
  \begin{tikzpicture}[%
    ...
    \node[state, rectangle, text width=1.4cm, align=center] (N1) {A\\$\textcolor{BrickRed}{EX(\textcolor{Blue}{\$B})}$};
...
\centering
  \begin{tikzpicture}[%
    ...
    \node[state, rectangle, text width=3cm, align=center] (N1) {A\\$\textcolor{BrickRed}{AX(\textcolor{Cerulean}{EX(\textcolor{RoyalPurple}{EX(\textcolor{OliveGreen}{\$E})})})}$};
